...
const I18N = {
  en:{
    ...
    "sub.cta":"Unlock now via Tribute","pay.head":"How payment works","pay.tribute.d":"Handles the charge & channel access","pay.safe":"SAFE","pay.apple.d":"One tap at Tribute checkout on iPhone, iPad & Mac",
  ...
  kz:{
    ...
    "sub.cta":"Tribute арқылы ашу","pay.head":"Төлем қалай жүреді","pay.tribute.d":"Төлем мен арнаға кіруді басқарады","pay.safe":"ҚАУІПСІЗ","pay.apple.d":"Tribute төлем бетінде iPhone, iPad және Mac-та бір түртумен",
  ...
  ru:{
    ...
    "sub.cta":"Открыть через Tribute","pay.head":"Как проходит оплата","pay.tribute.d":"Обрабатывает платёж и доступ к каналу","pay.safe":"БЕЗОПАСНО","pay.apple.d":"В один тап при оплате через Tribute на iPhone, iPad и Mac",
